...
cp $BASE_DIR/target/osx/x86_64/modules/java/test/.build/build/jar/opencv-test.jar upstream
cp -r $BASE_DIR/target/osx/x86_64/modules/java/test/.build/res/* upstream/res
